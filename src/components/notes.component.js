...
export default class NoteList extends Component
{
    ...
    componentDidMount() {
        ...
        if(aloo)
        {
            ...
            axios.get('http://localhost:5000/notes/email/'+aloo.email).then(response =>{
    ...
    addnew()
    {
        ...
        var newnote=axios.post('http://localhost:5000/notes/add/', {
                        ...
                        const printAddress = () => {
                            ...
                            // axios.get('http://localhost:5000/notes/email/'+this.state.email).then(response =>{
    ...
    {
        this.hideModal();
        axios.delete('http://localhost:5000/notes/'+id).then(res=> console.log(res.data));
        this.setState({
    ...
    myChangeHandler =  (event) => {
            ...
            axios.post('http://localhost:5000/notes/update/'+this.state.noteid, {
            "username": this.state.noteuser,
